package com.JavaLesson17.tryit;
...
public class NewsReaderGUI {
	...
	private void displayGUI() {
		...
		button.addActionListener(event -> {
			new NewsReader(new File("data/left.txt"), textAreaLeft, leftProgressBar).execute();
			new NewsReader(new File("data/right.txt"), textAreaRight, rightProgressBar).execute();
		});
	}
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(() -> new NewsReaderGUI().displayGUI());
	}
}